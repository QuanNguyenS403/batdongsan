...
export const SEARCH_SUGGESTIONS: SearchSuggestion[] = [
  ...
  { text: 'Đại học Kinh Tế Quốc Dân (NEU)', category: 'truong_dh', icon: '🎓' },
  { text: 'Đại học Kinh Doanh và Công Nghệ Hà Nội (HUBT)', category: 'truong_dh', icon: '🎓' },
  { text: 'Đại học Kinh Tế Kỹ Thuật Công Nghiệp (UNETI)', category: 'truong_dh', icon: '🎓' },
  { text: 'Đại học Mở Hà Nội (HOU)', category: 'truong_dh', icon: '🎓' },
  { text: 'Học viện Ngân Hàng', category: 'truong_dh', icon: '🎓' },
  { text: 'Đại học Xây Dựng Hà Nội', category: 'truong_dh', icon: '🎓' },
  { text: 'Đại học Thương Mại (TMU)', category: 'truong_dh', icon: '🎓' },
  { text: 'Đại học Ngoại Thương Hà Nội (FTU)', category: 'truong_dh', icon: '🎓' },
  { text: 'Đại học Sư Phạm Hà Nội', category: 'truong_dh', icon: '🎓' },
  { text: 'Học viện Công Nghệ Bưu Chính Viễn Thông (PTIT)', category: 'truong_dh', icon: '🎓' },
  { text: 'Đại học Kiến Trúc Hà Nội', category: 'truong_dh', icon: '🎓' },
  { text: 'Đại học Hà Nội (HANU)', category: 'truong_dh', icon: '🎓' },
  { text: 'Đại học Công Nghệ Giao Thông Vận Tải (UTT)', category: 'truong_dh', icon: '🎓' },
  { text: 'Đại học Lao Động Xã Hội (ULSA)', category: 'truong_dh', icon: '🎓' },
  { text: 'ĐH Khoa Học Xã Hội và Nhân Văn (USSH)', category: 'truong_dh', icon: '🎓' },
  { text: 'ĐH Khoa Học Tự Nhiên (HUS)', category: 'truong_dh', icon: '🎓' },
  { text: 'Đại học Y Hà Nội', category: 'truong_dh', icon: '🎓' },
  { text: 'Đại học Thăng Long', category: 'truong_dh', icon: '🎓' },
  { text: 'Đại học RMIT', category: 'truong_dh', icon: '🎓' },
