...
export const metadata: Metadata = {
  title: 'Chính sách bảo mật thông tin — BĐS Cho Thuê',
  description:
    'Cam kết bảo vệ dữ liệu cá nhân, số điện thoại và thông tin tài khoản của người dùng trên nền tảng BĐS Cho Thuê.',
};
