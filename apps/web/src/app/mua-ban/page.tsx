...
export const metadata: Metadata = {
  ...
  description: 'Danh sách tin đăng bán nhà, đất, căn hộ mới nhất trên toàn quốc. Lọc theo giá, diện tích, loại hình, khu vực.',
};
    ...
    <div className="min-h-screen bg-surface-muted">
      <div className="container-max py-8">
        ...
        <h1 className="text-2xl font-bold text-text-primary md:text-3xl">
          Mua bán nhà đất{searchParams.keyword ? ` — "${searchParams.keyword}"` : ''} mới nhất {month}
        </h1>
