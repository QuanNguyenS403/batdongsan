...
export function MembershipPricingClient({ initialPlans, activeSeason }: Props) {
      ...
      <div className="mt-16 rounded-3xl bg-slate-50 border border-slate-200/80 p-8 sm:p-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center sm:text-left">
          ...
          <div className="flex flex-col items-center sm:items-start">
            ...
            <p className="mt-1 text-xs text-slate-600">
              Cần hỗ trợ chụp ảnh, xác thực tin hoặc tư vấn định giá cho thuê? Hotline/Zalo: <strong>0981 753 082</strong>.
            </p>
          </div>
        </div>
      </div>
                      ...
                      <div className="rounded-2xl bg-slate-50 border border-slate-200 p-4 mb-4">
                        ...
                        <div className="space-y-1.5 text-xs text-slate-600">
                          ...
                          <div className="flex justify-between">
                            ...
                            <strong className="text-teal-700 font-mono text-sm">0981 753 082</strong>
                          </div>
                          <div className="flex justify-between">
                            <span className="text-slate-500">Chủ tài khoản:</span>
                            <strong className="text-slate-900">NGUYEN DUC QUAN</strong>
                          </div>
                          <div className="flex justify-between">
